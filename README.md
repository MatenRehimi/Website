Stack: react, jsx, css, firebase
Uses: Babel, Webpack and ESLint

Babel-Transpiles new JS (react code) to old JS that browsers can use.
...
##Autogenerated with create-react-app
